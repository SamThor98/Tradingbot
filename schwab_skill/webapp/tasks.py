...
def _phase2_stage1_overrides() -> dict[str, dict[str, str]]:
    ...
    return {
        ...
        # Track B peer generators (PF 1.50 dual-track). Canonical JSON copies:
        # research/env_overrides/pullback_only_aug.json, pead_primary_aug.json
        "pullback_only_aug": {
            "BACKTEST_ENTRY_FAMILY": "pullback",
            "META_POLICY_MODE": "off",
            "UNCERTAINTY_MODE": "off",
            "EVENT_RISK_MODE": "off",
            "EXIT_MANAGER_MODE": "off",
            ...
            "PTS_52W_CAP_MODE": "off",
            "EARLY_STOP_GATE_MODE": "off",
            "RANK_FILTER_V2_MODE": "off",
            "STRATEGY_PULLBACK_MODE": "shadow",
            "BACKTEST_AUGMENTED_LOGGING": "true",
            "BACKTEST_OHLC_PATH": "true",
        },
        "pead_primary_aug": {
            "BACKTEST_ENTRY_FAMILY": "pead_primary",
            "META_POLICY_MODE": "off",
            "UNCERTAINTY_MODE": "off",
            "EVENT_RISK_MODE": "off",
            "EXIT_MANAGER_MODE": "off",
