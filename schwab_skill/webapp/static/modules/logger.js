...
export const DIAG_LABELS = {
  ...
  signal_edge_shadow_mode: "Signal-edge shadow mode",
  rank_filter_would_drop_composite: "Rank shadow (composite)",
  rank_filter_would_drop_rank_v2: "Rank shadow (rank v2)",
  rank_filter_would_drop_signal: "Rank shadow (signal score)",
  rank_filter_would_drop_any: "Rank shadow (any rule)",
  stage2_shadow_would_filter: "Stage 2 shadow would filter",
  entry_timing_recommendation: "Entry-timing shadow recommendation",
  entry_shadow_would_filter_any: "Entry shadow (any rule)",
  entry_shadow_would_filter_sma50_low: "Entry shadow (SMA50 low cushion)",
